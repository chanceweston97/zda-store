...
export const getHeroSliders = async () => heroBanners; // Alias
export const getHeroIntroduction = async () => heroIntroduction;
export const getProudPartners = async () => proudPartners;
export const getWhatWeOffer = async () => whatWeOffer;
export const getOurStory = async () => ourStory;
export const getFaq = async () => ({ items: faqs });
