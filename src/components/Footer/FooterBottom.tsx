        ...
        <div className="max-w-[1440px] mx-auto">
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <div className="flex items-center gap-4 text-[20px]">
              {/* Facebook */}
              <a
                href="https://www.facebook.com/profile.php?id=61581475236017"
                className="flex items-center gap-2 px-5 py-2 rounded-full border border-white/30 hover:bg-white/10 transition"
                style={{ color: '#fff' }}
                target="_blank"
                rel="noopener noreferrer"
              >
              ...
              {/* LinkedIn */}
              <a
                href="https://www.linkedin.com/company/zda-comm/"
                className="flex items-center gap-2 px-5 py-2 rounded-full border border-white/30 hover:bg-white/10 transition"
                style={{ color: '#fff' }}
                target="_blank"
                rel="noopener noreferrer"
