      ...
      try {
        ...
        const response = await fetch(checkoutEndpoint, {
          ...
          body: JSON.stringify({
            ...
            shipping_address: {
              firstName: data.shipToDifferentAddress ? (data.shipping?.firstName || data.billing.firstName) : data.billing.firstName,
              lastName: data.shipToDifferentAddress ? (data.shipping?.lastName || data.billing.lastName) : data.billing.lastName,
              ...
              country: data.shipToDifferentAddress ? (data.shipping?.countryName || data.billing.regionName || data.billing.country) : (data.billing.regionName || data.billing.country),
              country_code: data.shipToDifferentAddress ? (data.shipping?.countryName || data.billing.regionName || data.billing.country) : (data.billing.regionName || data.billing.country),
              state: data.shipToDifferentAddress ? (data.shipping?.stateOrProvince || "") : (data.billing.stateOrProvince || ""),
              postalCode: data.shipToDifferentAddress ? (data.shipping?.zipCode || data.billing.zipCode || "00000") : (data.billing.zipCode || "00000"),
